...
public class Employee extends User {
    ...
    public String toString() {
        StringBuilder healthInspectionDetails = new StringBuilder();
        for (Date date : healthInspection.keySet()) {
            healthInspectionDetails.append(new SimpleDateFormat("dd MMMM yyyy").format(date))
                    .append(" - ")
                    .append(healthInspection.get(date))
                    .append("; ");
        }
        return "Employee ID: " + getID() +
                ...
                "\nWork Permit End Date: " + getWorkPermitEndDate() +
                "\nHealth Inspections: " + healthInspectionDetails;
    }
